...
_Int8Cp: TypeAlias = Union['Int8', int]

class Int8(drjit.ArrayBase[Int8, _Int8Cp, int, int, Int8, Int8, Bool]):
    pass

_UInt8Cp: TypeAlias = Union['UInt8', int]
...
_Array0i8Cp: TypeAlias = Union['Array0i8', '_Int8Cp', 'drjit.scalar._Array0i8Cp']
...
_Array0u8Cp: TypeAlias = Union['Array0u8', '_UInt8Cp', 'drjit.scalar._Array0u8Cp']
...
_Array1i8Cp: TypeAlias = Union['Array1i8', '_Int8Cp', 'drjit.scalar._Array1i8Cp']
...
_Array1u8Cp: TypeAlias = Union['Array1u8', '_UInt8Cp', 'drjit.scalar._Array1u8Cp']
...
_Array2i8Cp: TypeAlias = Union['Array2i8', '_Int8Cp', 'drjit.scalar._Array2i8Cp']
...
_Array2u8Cp: TypeAlias = Union['Array2u8', '_UInt8Cp', 'drjit.scalar._Array2u8Cp']
...
_Array3i8Cp: TypeAlias = Union['Array3i8', '_Int8Cp', 'drjit.scalar._Array3i8Cp']
...
_Array3u8Cp: TypeAlias = Union['Array3u8', '_UInt8Cp', 'drjit.scalar._Array3u8Cp']
...
_Array4i8Cp: TypeAlias = Union['Array4i8', '_Int8Cp', 'drjit.scalar._Array4i8Cp']
...
_Array4u8Cp: TypeAlias = Union['Array4u8', '_UInt8Cp', 'drjit.scalar._Array4u8Cp']
...
_ArrayXi8Cp: TypeAlias = Union['ArrayXi8', '_Int8Cp', 'drjit.scalar._ArrayXi8Cp']

class ArrayXi8(drjit.ArrayBase[ArrayXi8, _ArrayXi8Cp, Int8, _Int8Cp, Int8, ArrayXi8, ArrayXb]):
    pass

_ArrayXu8Cp: TypeAlias = Union['ArrayXu8', '_UInt8Cp', 'drjit.scalar._ArrayXu8Cp']
...
def register_gl_buffer(gl_buffer: int) -> types.CapsuleType:
    """
...
def register_gl_texture(gl_texture: int) -> types.CapsuleType:
    """
...
def unregister_cuda_resource(cuda_resource: types.CapsuleType) -> None:
    """
...
def map_graphics_resource_ptr(cuda_resource: types.CapsuleType) -> tuple[int, int]:
    """
...
def map_graphics_resource_array(cuda_resource: types.CapsuleType, mip_level: int = 0) -> int:
    """
...
def unmap_graphics_resource(cuda_resource: types.CapsuleType) -> None:
    """
...
def memcpy_2d_to_array_async(dst: int, src: int, src_pitch: int, height: int, from_host: bool = False) -> None:
    """
...
class GLInterop:
    ...
    @staticmethod
    def from_buffer(arg: int, /) -> GLInterop:
        """
    ...
    @staticmethod
    def from_texture(arg: int, /) -> GLInterop:
        """
    ...
    def map(self, mip_level: int = 0) -> GLInterop:
        """
    ...
    def upload(self, arg: Annotated[NDArray, dict(order='C', device='cuda', writable=False)], /) -> GLInterop:
        """
